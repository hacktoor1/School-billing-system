    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"root")==0 && strcmp(pword,"root")==0)
	{
	printf("  \n\n\n       WELCOME TO international school  's BILLING SYSTEM !!!! LOGIN IS SUCCESSFUL");
...
void main(void)
{
    ...
    printf("                    \t**********************************************************\n");
    printf("                    \t*                                                        *\n");
    printf("                    \t***             WELCOME TO  international school       ***\n");
    printf("                    \t*                  >>Billing System<<                    *\n");
    printf("                    \t*                 international school                   *\n");
    printf("                    \t*                       Address                          *\n");
    printf("                    \t*                    Tel.0112397690                      *\n");
    printf("                    \t*                                                        *\n");
    printf("                    \t**********************************************************\n");
    printf("\n");
    printf("\n");
    ...
    system("color 0");
    printf("\n\n\t || WELCOME TO  INTERNATIONAL SCHOOL's BILLING SYSTEM  || \n\n\n");
    for(i=0; i<80; i++)
    {
        printf("\xdb");
    }
...
void ext()
{
    ...
    printf("                    \t                                                          \n");
    printf("                    \t**********************************************************\n");
    printf("                    \t***              Dr. Sherif & Eng. Hamdy               ***\n");
    printf("                    \t***        created by::Abdelrahman Ali Abdelaziz       ***\n");
    printf("                    \t***                     ID:121267                      ***\n");
    printf("                    \t**********************************************************\n");
    printf("                    \t                                                          \n");
